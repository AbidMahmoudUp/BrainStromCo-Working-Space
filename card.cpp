    ...
    uiCard(new Ui::Card)
{
   ...
   // uiCard->id_office->setVisible(false);
     ...
     uiCard->space_office->setVisible(true);
...
void Card::on_seeMoreBtn_clicked()
{
  ...
  Office  office =  Office(this->getOfficeID(),this->getOfficeImage(),this->getOfficeDescription(),this->getOfficePrice(),this->getNameOffice(),this->getSpaceOffice(),this->getPostionOffice(),"available",this->getTypeOffice(),this->getDateOffice());
