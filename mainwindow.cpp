...
void MainWindow::on_lowest_button_clicked()
{
  ...
  Office * office;
  dataSet = office->getOfficesByPriceDESC();
  std::list<Office*>::iterator it1;
...
void MainWindow:: on_heighest_button_clicked()
{
  ...
  Office * office;
  dataSet = office->getOfficesByPriceASC();
  std::list<Office*>::iterator it1;
...
{ dataSet.erase(dataSet.begin(),dataSet.end()) ;
  ...
  Office * office;
  dataSet = office->getOfficesByTypeOpen();
  std::list<Office*>::iterator it1;
...
void MainWindow::on_office_button_clicked()
{
  dataSet.erase(dataSet.begin(),dataSet.end()) ;
    ...
    Office * office;
    dataSet = office->getOfficesByTypeClose();
    std::list<Office*>::iterator it1;
...
void MainWindow:: on_available_button_clicked()
{
  dataSet.erase(dataSet.begin(),dataSet.end()) ;
    ...
    Office * office;
    dataSet = office->getOfficesByStatusAvailable();
    std::list<Office*>::iterator it1;
...
void MainWindow:: on_not_available_button_clicked()
{
  dataSet.erase(dataSet.begin(),dataSet.end()) ;
    ...
    Office * office;
    dataSet = office->getOfficesByStatusNotAvailable();
    std::list<Office*>::iterator it1;
...
void MainWindow:: on_asc_button_clicked()
{
  dataSet.erase(dataSet.begin(),dataSet.end()) ;
    ...
    Office * office;
    dataSet = office->getOfficesBySpaceASC();
    std::list<Office*>::iterator it1;
