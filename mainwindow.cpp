...
void MainWindow::on_add_reservation_button_clicked()
{
  ...
  QString image = "113";//we have to make url line in the pop up widget
  QString description="15";
  QString price="15/25/2563";
  QString name="1252";
  QString space=ui->space_line->text();
  QString position=ui->position_line->text();
  QString status="available";
  ...
  QString date=ui->date_line->text();
  Reservation * reservation = new Reservation(id_reservation,image,description,price,name);
  Reservation stock(id_reservation,image,description,price,name);
...
void MainWindow:: on_edit_reservation_clicked()
{
  ...
  QString id_reservation="1";
  QString id_office="107";
  QString cin="1598752";
  QString check_in;
  QString check_out;
