...
void MainWindow::on_add_office_button_clicked()
{
  ...
  if(check){
      ...
      ui->layout_popUp->addWidget(pop);


      ui->popup_stacked_widget->setCurrentIndex(1);

      /*PopUp *pop=new PopUp(icon,title,description);


      //ui->add_office_widget->setVisible(true);
     // QPixmap pix("C:/Users/Mon Pc/Desktop/Qt projects/BrainStormSpace/img/success_icon.png");
      ui->pop_up_icon->setPixmap(pop->getIcon());
      ui->title_container_pop_up->setText(pop->getTitel());
      ui->description_pop_up->setText(pop->getDescription());*/

    }
  else{
      ui->popup_stacked_widget->setCurrentIndex(1);
      ui->add_office_widget->setVisible(true);
      QPixmap pix("C:/Users/Mon Pc/Desktop/Qt projects/BrainStormSpace/img/failed_icon.png");
     // ui->pop_up_icon->setPixmap(pix);
      //ui->title_container_pop_up->setText("Success !");
      //ui->description_pop_up->setText("The product have been added to this staging \n                    table successfully");
    }
...
{
   ui->edit_office_widget->setVisible(true);
}
