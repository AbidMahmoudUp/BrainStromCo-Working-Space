...
{
  Reservation  reservation =  Reservation(this->getIdReservation(),this->getIdReservation(),this->getCINReservation(),this->getCheckInReservation(),this->getCheckOutReservation(),this->getNameOfficeReservation());
